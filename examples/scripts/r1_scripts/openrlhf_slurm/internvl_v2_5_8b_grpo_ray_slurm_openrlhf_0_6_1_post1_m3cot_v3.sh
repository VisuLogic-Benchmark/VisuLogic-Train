...
#SBATCH -o logs/internvl_v2_5/grpo/m3cot_v3.log
#SBATCH -e logs/internvl_v2_5/grpo/m3cot_v3.log
...
JOBLOG="${CURR_DIR}/logs/internvl_v2_5/grpo/m3cot_v3.log"

echo "pwd=$(pwd)"
echo "JOBLOG=${JOBLOG}"
echo "$(date '+%Y-%m-%d %H:%M:%S') Job ${SLURM_JOB_ID} started ..." &>> ${JOBLOG}

OUTPUT_DIR="${CURR_DIR}/outputs/internvl_v2_5/grpo_openrlhf_0_6_1_post1_m3cot_v3"
