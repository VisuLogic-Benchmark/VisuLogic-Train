...
#SBATCH -o logs/internvl_v2_5/rloo/m3cot_v0.log
#SBATCH -e logs/internvl_v2_5/rloo/m3cot_v0.log
...
JOBLOG="${CURR_DIR}/logs/internvl_v2_5/rloo/m3cot_v0.log"
...
OUTPUT_DIR="${CURR_DIR}/outputs/internvl_v2_5/rloo_openrlhf_0_6_1_post1_m3cot_v0"
