...
#SBATCH -o logs/internvl_v2_5/grpo/mmpr_v0.log
#SBATCH -e logs/internvl_v2_5/grpo/mmpr_v0.log
...
JOBLOG="${CURR_DIR}/logs/internvl_v2_5/grpo/mmpr_v0.log"

echo "pwd=$(pwd)"
echo "JOBLOG=${JOBLOG}"
echo "$(date '+%Y-%m-%d %H:%M:%S') Job ${SLURM_JOB_ID} started ..." &>> ${JOBLOG}

OUTPUT_DIR="${CURR_DIR}/outputs/internvl_v2_5/grpo_v2"
...
export ACC_REWARD_PATH="${CURR_DIR}/logs/acc_reward_mmpr.log"
export FORMAT_REWARD_PATH="${CURR_DIR}/logs/format_reward_mmpr.log"
...
"   ray job submit --address=http://localhost:8265 \
    ...
    --meta_path ${CURR_DIR}/datasets/internvl/meta/mmpr_v0.json \
