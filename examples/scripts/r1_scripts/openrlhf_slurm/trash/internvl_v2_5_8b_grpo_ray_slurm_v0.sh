...
OUTPUT_DIR="/mnt/petrelfs/wangweiyun/workspace_wwy/OpenRLHF-250228/outputs/internvl_v2_5/grpo_v0"
...
"   ray job submit --address=http://localhost:8265 \
    ...
    --meta_path /mnt/petrelfs/wangweiyun/workspace_wwy/OpenRLHF-250228/datasets/internvl/meta/m3cot_10x.json \
