export DATASET="/mnt/afs/wangjiahao/workspace/o1_r1/lmm-r1/workspace/eval/scienceqa/splits/train_format.jsonl"
#export DATASET="/mnt/afs/wangjiahao/workspace/o1_r1/lmm-r1/examples/data/test_message_wo_image_multi.jsonl"
MODEL_CPK_NAME="qwenvl25_3B_ins_rloo_sciqa"
...
ray job submit --address="http://127.0.0.1:8265" \
   ...
   --max_ckpt_num 10 \
   --use_wandb 9ee3a42f350e28930238979d211e44e28bf8d111 \
   2>&1 | tee ${LOG_PATH}
